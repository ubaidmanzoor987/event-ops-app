      ...
      <div className="relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px]">
        <div className="flex flex-col justify-between w-[20px] h-[20px] transform transition-all duration-200 origin-center overflow-hidden">
          <div
            className={cn(
              [
                'bg-accent-foreground h-[2px] w-7 transform transition-all duration-200 origin-left delay-75',
              ],
              open && 'translate-y-6'
            )}
          ></div>
          <div
            className={cn([
              'bg-accent-foreground h-[2px] w-7 rounded transform transition-all duration-200 delay-50',
              open && 'translate-y-6',
            ])}
          ></div>
          <div
            className={cn([
              'bg-accent-foreground h-[2px] w-7 transform transition-all duration-200 origin-left',
              open && 'translate-y-6',
            ])}
          ></div>
          ...
          >
            <div
              className={cn([
                'absolute bg-accent-foreground h-[2px] w-5 transform transition-all duration-400 rotate-0 delay-200',
                open && 'rotate-45',
              ])}
            ></div>
            <div
